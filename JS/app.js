$(document).ready(function(){
    ...
    var entriesL = [  {target: '_top',url: '#about', label: 'Command Prompt'},  {target: '_top',url: '#about', label: 'Powershell'},  {target: '_top',url: '#about', label: 'Git Bash'},  {target: '_top',url: '#about', label: 'Github'}, {target: '_top',url: '#about', label: 'Javascript'},  {target: '_top',url: '#about', label: 'Python'},  {target: '_top',url: '#about', label: 'PHP'},  {target: '_top',url: '#about', label: 'Java'},  {target: '_top',url: '#about', label: 'Kotlin'},  {target: '_top',url: '#about', label: 'Julia'},  {target: '_top',url: '#about', label: 'Go'},  {target: '_top',url: '#about', label: 'SQL'},  {target: '_top',url: '#about', label: 'API'}, {target: '_top',url: '#about', label: 'DBMS'},  {target: '_top',url: '#about', label: 'File Handling'},  {target: '_top',url: '#about', label: 'Object Oriented Programming'},   {target: '_top',url: '#about', label: 'C++'},  {target: '_top',url: '#about', label: 'C'},  {target: '_top',url: '#about', label: 'Data Structures'},  {target: '_top',url: '#about', label: 'Algorithms'},  {target: '_top',url: '#about', label: 'Batch Scripting'},  {target: '_top',url: '#about', label: 'JSON'}, ];
    ...
    var entriesT = [  {target: '_top',url: '#about', label: 'PyGame'},  {target: '_top',url: '#about', label: 'Pycharm'},  {target: '_top',url: '#about', label: 'Visual Studio Code'},  {target: '_top',url: '#about', label: 'Jupyter Notebook'},  {target: '_top',url: '#about', label: 'Anaconda'}, {target: '_top',url: '#about', label: 'Tkinter'},  {target: '_top',url: '#about', label: 'Turtle Graphics'},  {target: '_top',url: '#about', label: 'Scrapy'},  {target: '_top',url: '#about', label: 'Exception Handling'},  {target: '_top',url: '#about', label: 'Multithreading'},  {target: '_top',url: '#about', label: 'OS, Sys, Subprocess'},  {target: '_top',url: '#about', label: 'Beautiful Soup'},  {target: '_top',url: '#about', label: 'OpenCV'},  {target: '_top',url: '#about', label: 'Sockets'}, {target: '_top',url: '#about', label:'Translate'},  {target: '_top',url: '#about', label:'Unittesting'}, {target: '_top',url: '#about', label:'Selenium'}, {target: '_top',url: '#about', label:'SymPy'},  {target: '_top',url: '#about', label:'SMTP'}, {target: '_top',url: '#about', label:'Regular Expressions'}, {target: '_top',url: '#about', label:'Logging'},  {target: '_top',url: '#about', label:'Generators'}, {target: '_top',url: '#about', label:'Context Managers'},  {target: '_top',url: '#about', label:'Decorators'},  {target: '_top',url: '#about', label:'Requests'}];
